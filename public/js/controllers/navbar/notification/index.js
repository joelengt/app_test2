						...
						var template = `<div class="Report">
											<div class="Report__containner">
												...
												<div class="Report__containner--description">
													...
													<div class="Description__reported">
														<p>Esta orden ya ha sido ${content.type_answer}</p>
													</div>
												</div>
												<div class="Report__containner--btns">
													<div class="close">
														<button data-order="${content.work_order_id}" data-response="no" id="cerrarReporte">Cerrar</button>
													</div>
												</div>
											</div>
										</div>`
