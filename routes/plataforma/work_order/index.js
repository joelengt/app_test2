...
function BuildWorkFilters (arr_work, cb11) {
    ...
    if(arr_work.length === 0) {
        ...
        arr_work_orders_new = arr_work;
        console.log('A punto de ordenarlos');

        // Ordenando de forma Mayor a Menor
        for(var m = 1; m <= arr_work_orders_new.length; m++) {
            console.log('Item : ' + m);
            for(var f = 0; f < arr_work_orders_new.length - m; f++) {
                console.log('>>>X');
                
                console.log(arr_work_orders_new[f].codigo_orden);
                console.log(arr_work_orders_new[f + 1].codigo_orden);


                var numeric_compare_A = Number(arr_work_orders_new[f].codigo_orden.replace('NWO_00', ''));
                var numeric_compare_B = Number(arr_work_orders_new[f + 1].codigo_orden.replace('NWO_00', ''));

                console.log('A ' + numeric_compare_A);
                console.log('B ' + numeric_compare_B);

                if(numeric_compare_A > numeric_compare_B) {
                    var element_arr = arr_work_orders_new[f];

                    arr_work_orders_new[f] = arr_work_orders_new[f + 1];
                    arr_work_orders_new[f + 1] = element_arr;
                }
            }                        
        ...
        for (var m = 0; m <= arr_work_orders_new.length - 1; m++) {
           console.log(arr_work_orders_new[m].codigo_orden.replace('NWO_00', ''))
        }
...
function FormPlataformWorkOrder(app, io) {
                               ...
                               codigo_contratista !== undefined) {
                                ...
                                if(tipo_servicio === 'tipo_servicio_P' ||
                                   tipo_servicio === 'tipo_servicio_C') {
                                    ...
                                    //     BuildWorkFilters(orders_status_en_curso, function (err, orders_status_en_curso1) {
                                    //         if(err) {
                                    //             return res.status(500).json({
                                    //                 status: 'error_server',
                                    //                 error: err
                                    ...
                                    //                             status: 'ok',
                                    //                             work_orders: {
                                    //                                 pendiente:    orders_status_pendientes1,
                                    //                                 en_curso:     orders_status_en_curso1,
                                    //                                 resuelto:     orders_status_resueltas1,
                                    //                                 no_resuelto:  orders_status_no_resueltas1,
                                    //                                 cancelado:    orders_status_cancelado1,
                                    //                                 reportado:    orders_status_reportado1
                                    //                             }
                                    //                         })
                        ...
                        if(encontrado === true) {
                            ...
                            if(type_service === 'poste' && type_element === 'poste') {
                                    ...
                                    if(req.files.hasOwnProperty('new_file_upload')) {
                                        ...
                                        Poste.findById({'_id': service_id}, function (err, poste_find){
                                            ...
                                            Poste.update({'_id': service_id}, data_1, function (err) {
                                                ...
                                                if(work_order_item.progress_to_complete === 0) {
                                                    // Asignando estado: No Resuelto por defecto al enviar
                                                    work_order_item.estado = work_order_status.no_resuelto

                                                }

                                                // Validando cumplimiento de Tarea:: Poste
                                                if (data_1.codigo_poste !== '' && 
                                                    data_1.type_poste !== '' &&
                                                    data_1.altura_poste !== '' &&
                                                    data_1.type_material !== '' &&
                                                    data_1.type_pastoral !== '' &&
                                                    data_1.type_luminaria !== '' &&
                                                    data_1.type_lampara !== '' &&
                                                    data_1.coordenada_X !== '' &&
                                                    data_1.coordenada_Y !== '' &&
                                                    data_1.estado_poste !== '' &&
                                                    data_1.estado_pastoral !== '' &&
                                                    data_1.estado_luminaria !== '' &&
                                                    data_1.estado_lampara !== '') {

                                                    work_order_item.progress_to_complete += 1
                                                    console.log('PROGREESS TO COMPLETE!! +1')
                                        ...
                                        console.log('IMAGEN 360 LISTO PARA RECORTAR')

                                        console.log(FilesCover)

                                        // Redimencionando imagen 360
                                        if(FilesCover.extension === 'jpg' && FilesCover.mimetype === 'image_360') {

                                            var filePath = `${scope_path_system}/uploads/news/${FilesCover.name}`

                                            sharp(filePath)
                                              //.resize(4000)
                                              .compressionLevel(5)
                                              .toFile(`${scope_path_system}/uploads/news/re_${FilesCover.name}`, function(err) {
                                                ...
                                                FilesCover.filename = `re_${FilesCover.name}`
                                                FilesCover.name = `re_${FilesCover.name}`
                                                FilesCover.path = `uploads/news/${FilesCover.name}`

                                                console.log("Imagen redimencianada")

                                                console.log('---------------')

                                                console.log('Nuevo archivo resized  <<<<<<<<>>>>>>')
                                                console.log(FilesCover)
                                                console.log('<<<<<<<<>>>>>>>>>>>')
                                            ...
                                            console.log('Error: La imagen subida no es 360')
                                            res.status(200).json({
                                                status: 'not_found',
                                                message: 'Error: La imagan subida no es 360',
                                                user: usuario_token,
                                                work_order: work_order_item
                                            })
                                        }
                                ...
                                Cliente.findById({'_id': service_id}, function (err, client_find22){
                                    ...
                                    // Validando Registro de urbanizacion
                                    if(req.body.hasOwnProperty('new_string_urbanizacion') &&  data_element !== '') {
                                         
                                        // Validando exitencia en la base de datos
                                        Usuarios.findOne({'name': 'URB. ' + data_element}, function (err, result) {
                                            if(err) {
                                                return res.status(500).json({
                                                    status: 'error_server',
                                                    error: err
                                            ...
                                            if(result === null) {
                                                ...
                                                new_urbs.save(function (err) {
                                                    ...
                                                    console.log('Nueva Urbanizacion guardada: ' + new_urbs);
                                                ...
                                                console.log('La Urbanizacion ya se encuentra registrada: ' + result);
                                    ...
                                    if(req.files.hasOwnProperty('new_file_upload')) {
                                        ...
                                        Cliente.findById({'_id': service_id}, function (err, client_find){
                                            ...
                                            Cliente.update({'_id': service_id}, data_2, function (err) {
                                                ...
                                                // Validando cumplimiento de Tarea:: Poste
                                                if (data_2.cliente_id  !== '' &&              
                                                    data_2.numero_cliente  !== '' &&         
                                                    data_2.codigo_via  !== '' &&              
                                                    data_2.distrito  !== '' &&                
                                                    data_2.urbanizacion  !== '' &&             
                                                    data_2.numero_puerta  !== '' &&           
                                                    data_2.numero_interior  !== '' &&         
                                                    data_2.manzana  !== '' &&                 
                                                    data_2.lote  !== '' &&                    
                                                    data_2.nombre_de_cliente  !== '' &&       
                                                    data_2.type_residencial  !== '' &&        
                                                    data_2.is_maximetro_bt  !== '' &&         
                                                    data_2.type_conexion  !== '' &&           
                                                    data_2.type_acometida  !== '' &&          
                                                    data_2.type_cable_acometida  !== '' &&    
                                                    data_2.calibre_cable_acometida  !== '' && 
                                                    data_2.calibre_cable_matriz  !== '' &&    
                                                    data_2.coordenada_X  !== '' &&            
                                                    data_2.coordenada_Y  !== '') {
                                        ...
                                        // Redimencionando imagen 360
                                        if(FilesCover2.extension === 'jpg' && FilesCover2.mimetype === 'image_360') {

                                            console.log('La imagen es 360 <<<')

                                            var filePath = `${scope_path_system}/uploads/news/${FilesCover2.name}`

                                            console.log('Path del 360')
                                            console.log(filePath)

                                            sharp(filePath)
                                              .compressionLevel(5)
                                              //.resize(4000) 
                                              .toFile(`${scope_path_system}/uploads/news/re_${FilesCover2.name}`, function(err) {
                                                // output.jpg is a 300 pixels wide and 200 pixels high image
                                                // containing a scaled and cropped version of input.jpg
                                                if(err) {
                                                ...
                                                FilesCover2.filename = `re_${FilesCover2.name}`
                                                FilesCover2.name = `re_${FilesCover2.name}`
                                                FilesCover2.path = `uploads/news/${FilesCover2.name}`
                                        ...
                                        } else if (data_2.suministro_derecha.coordX === null || data_2.suministro_derecha.coordY === null) {
                                        ...
                                        } else if (data_2.suministro_izquierda.coordX === null || data_2.suministro_izquierda.coordY === null) {
                                        ...
                                        } else if (data_2.poste_cercano.coordX === null || data_2.poste_cercano.coordY === null) {
    ...
    app.delete('/plataforma/work-order/:work_order_id/delete/:type_service/:service_id/item/:position_name', ensureAuthorized, function (req, res) {
        Usuarios.findOne({'token_auth': req.token_auth}, function (err, usuario_token) {
            if(err) {
                return res.status(500).json({
                    status: 'error_server',
                ...
                if(usuario_token.permiso === users_type.onwers || 
                   ...
                   var service_id = req.params.service_id
                   var work_order_id = req.params.work_order_id
                   var position_name_to_delete = req.params.position_name
                   var position_to_delete
                            ...
                            if(work_order_3) {
                                ...
                                if(type_service === 'poste') {
                                    ...
                                    Poste.findById({'_id': service_id}, function (err, poste_find_now) {
                                        ...
                                        console.log('Arreglo de Multimedia Poste')
                                        console.log(poste_find_now.imagen_poste)

                                        console.log('-------------')

                                        // Buscando elemento por nombre
                                        position_to_delete = 'not_found';

                                        for(var y = 0; y <= poste_find_now.imagen_poste.length - 1; y++) {
                                            var element_arr = poste_find_now.imagen_poste[y];
                                            
                                            // Evaluanado coincidencia
                                            if(element_arr.name === position_name_to_delete) {
                                                position_to_delete = y;
                                                break;
                                            }
                                        }
                                        ...
                                        console.log(position_to_delete);

                                        if(position_to_delete === 'not_found') {
                                            console.log('Elemento no encontrado')

                                            // Estado de respuesta
                                            res.status(200).json({
                                                status: 'not_found',
                                                message: 'Elemento multimedia, No se encontro',
                                                user: usuario_token,
                                            ...
                                            // El emento fue encontrado
                                            console.log('El elemento fue encontrado')

                                            console.log('Elemento a eliminar')
                                            console.log('Position: ' + position_to_delete);

                                            console.log('Ubicacion el el arreglo   <<<< << <  DATOS del elemento')
                                            console.log(poste_find_now.imagen_poste[position_to_delete])

                                            // Buscando elemento multimedia para eliminar, por posicion
                                            poste_find_now.imagen_poste.splice(position_to_delete,1)

                                            console.log('Arreglo de multimedia del poste ELIMINADO <<<<<')
                                            console.log(poste_find_now.imagen_poste)
                                    ...
                                    Cliente.findById({'_id': service_id}, function (err, cliente_find_now) {
                                        ...
                                        console.log('Arreglo de Multimedia Poste')
                                        console.log(cliente_find_now.imagen_cliente)

                                        console.log('-------------')
                                        
                                         // Buscando elemento por nombre
                                        position_to_delete = 'not_found';
                                        for(var w = 0; w <= cliente_find_now.imagen_cliente.length - 1; w++) {
                                            var element_arr = cliente_find_now.imagen_cliente[w];
                                            
                                            // Evaluanado coincidencia
                                            if(element_arr.name === position_name_to_delete) {
                                                position_to_delete = w;
                                                break;
                                            }
                                        }
                                        ...
                                        if(position_to_delete === 'not_found') {
                                          console.log('Elemento no encontrado')
                                            ...
                                            console.log('Ubicacion el el arreglo   <<<< << <  DATOS del elemento')
                                            console.log(cliente_find_now.imagen_cliente[position_to_delete])
    ...
    app.get('/test', function (req, res) {
        ...
        var FilesCover = {
            filename: 'b11b0c42232499e435b55903946b772d.jpg'
        }

        var filePath = `${scope_path_system}/uploads/news/${FilesCover.filename}`

        sharp(filePath)
          //.resize(4000)
          .compressionLevel(5)
          .toFile(`${scope_path_system}/uploads/news/re_${FilesCover.filename}`, function(err) {
            // output.jpg is a 300 pixels wide and 200 pixels high image
            // containing a scaled and cropped version of input.jpg
            if(err) {
                return res.status(500).json({
            ...
            FilesCover.filename = `re_${FilesCover.filename}`
